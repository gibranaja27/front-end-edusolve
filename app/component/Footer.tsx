  ...
  return (
    <section className="pt-20 md:pt-32 pb-20 md:pb-24 bg-white px-6">
      ...
      <div className="flex flex-col gap-4 items-center justify-center text-center">
        <h1 className="text-3xl md:text-3xl font-sans font-semibold text-black">
          Fitur Keunggulan
        </h1>
        <p className="text-lg md:text-xl text-black font-sans max-w-2xl">
      ...
      <div className="flex flex-col gap-24 md:gap-40 mt-20 md:mt-40">
        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-10 md:gap-80">
          ...
          <div className="flex flex-col gap-4 items-center text-center">
            <img src="number-one.png" alt="" className="w-12 md:w-24" />
            <h1 className="text-2xl md:text-3xl text-purple-700 font-semibold">
              Materi Terstruktur
            </h1>
            <p className="text-black text-base md:text-xl max-w-md">
        ...
        <div className="flex flex-col md:flex-row-reverse items-center justify-center gap-10 md:gap-80">
          <img src="mentoring.png" alt="" className="w-40 md:w-60" />

          <div className="flex flex-col gap-4 items-center text-center">
            <img src="number-2.png" alt="" className="w-12 md:w-24" />
            <h1 className="text-2xl md:text-3xl text-purple-700 font-semibold">
        ...
        {/* Feature 3 */}
        <div className="flex flex-col md:flex-row items-center justify-center gap-10 md:gap-80">
          <img src="certificate.png" alt="" className="w-40 md:w-60" />

          <div className="flex flex-col gap-4 items-center text-center">
            <img src="number-3.png" alt="" className="w-12 md:w-24" />
            <h1 className="text-2xl md:text-3xl text-purple-700 font-semibold">
